...
<template>
    ...
    <div class="grid place-items-center bg-[#ECECEC] h-screen overflow-y-auto">
                                ...
                                <form class="  " @submit.prevent="onSubmit">
                                    ...
                                    <div class="">
                                        <div class="np-image-upload-picker"
                                            ...
                                            <div class="w-full justify-center flex"><img
                                                    ...
                                                    alt="photo" id="pic" class="   h-44 w-44 pl-2  rounded-full   ">
                                            </div>

                                        </div>
                                        <div class="flex space-x-2 w-full justify-center"
                                            v-if="imageFile != null && imageFile.length != 0">
                                            <img class=" mt-10  h-auto w-44 pl-2  rounded-full  "
                                                :src=" hh.profile_pic" />
                                            <div class=" pt-44  ">
                                    ...
                                    <div class=" flex-row justify-center p-12 w-[500px] bg-white ">
                                        <div class="">
                                            <div>
                                                <label for="first name"
                                                    ...
                                                    First name: </label>
                                                <input type="text" name="name" v-model="fullprofile.readProfile.f_name"
                                            ...
                                            <div class="">
                                                <label for="last name"
                                                    class="block text-sm font-medium text-gray-900 dark:text-one">
                                                    Last name:</label>
                                                <input type="text" name="name" v-model="fullprofile.readProfile.l_name"
                                                    class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                                    required="">
                                            </div>
                                        </div>
                                        <div class="mt-4 flex space-x-6">
                                            <span class="text-one mt-2">Gender:</span>
                                            <div class="mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" class="form-radio"
                                                        v-model="fullprofile.readProfile.gender" name="accountType"
                                                        value="Male">
                                                    <span class="ml-2 text-one">Male</span>
                                                </label>
                                                <label class="inline-flex items-center ml-6">
                                                    <input type="radio" class="form-radio " name="accountType"
                                                        v-model="fullprofile.readProfile.gender" value="Female">
                                                    <span class="ml-2 text-one ">Female</span>
                                                </label>
                                                <label class="inline-flex items-center ml-6">
                                                    <input type="radio" class="form-radio" name="accountType"
                                                        v-model="fullprofile.readProfile.gender" value="other">
                                        ...
                                        <div class="flex space-x-5">
                                            <label for="last name" class="block mt-5   text-gray-900 dark:text-one">
                                                Birthdate:</label>
                                            <input type="date" name="name" v-model=" fullprofile.readProfile.birth_day"
                                                class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                        ...
                                        <label class="block">
                                            <span class=" text-one">Country</span>
                                            <select @change="selectCategory($event)"
                                                v-model="fullprofile.readProfile.country"
                                                class="form-select block w-full mt-1 bg-[#ECECEC]">
                                                <option value="Option 1">Option 1</option>
                                                <option value="Option 2">Option 2</option>
                                            </select>
                                        </label>
                                        <label class="block">
                                            <span class=" text-one"> genre</span>
                                            <select @change="selectCategor($event)"
                                                v-model="  fullprofile.readProfile.genre"
                                                class="form-select block w-full mt-1 bg-[#ECECEC]">
                                        ...
                                        <div>
                                            <label for="last name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-one">
                                                City</label>
                                            <input type="text" name="name" v-model="fullprofile.readProfile.city"
                                                class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                        ...
                                        <div>
                                            <label for="last name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-one">
                                                BIO</label>
                                            <input type="text" name="name" v-model="fullprofile.readProfile.bio"
                                                class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                        ...
                                        <div>
                                            <label for="last name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-one">
                                                phone number</label>
                                            <input type="text" name="name" v-model="fullprofile.readProfile.phone"
                                                class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                                placeholder="+251.." required="">
                                        </div>
                                        <div>
                                            <label for="last name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-one">
                                                email</label>
                                            <input type="email" name="email" v-model="fullprofile.readProfile.email"
                                                class="bg-white  border-b border-one textone sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                                placeholder="example@gmail.com" required="">
                                        </div>
                                        <div>
                                            <label for="description"
                                                class="block mb-2 text-sm font-medium text-one">description</label>
                                            <textarea type="text" name="description" id="password"
                                                v-model="fullprofile.readProfile.short_description"
                                        ...
                                        <!-- <label for="first name"
                                            class="block  text-sm font-medium text-gray-900 dark:text-one">
                                            tiktok link: </label>
                                        <input type="text" name="name" v-model="  hh.tiktok_link"
                                            class="bg-white border-b mb-1 border-one textone sm:text-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   focus:outline-none"
                                            required=""> -->
                                    </div>
                                    <div class="flex w-full justify-center mt-4">
                                        ...
                                        <!-- <button type="submit"
                                            class="w-full text-[#ECECEC]   bg-gradient-to-r from-[#B67B46] to-[#82460A] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">save
                                        </button> -->
                                        <button
                                            class="w-full text-[#ECECEC]   bg-gradient-to-r from-[#B67B46] to-[#82460A] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                            save
                                        </button>
                                        <!-- <div class="text-3xl bg-red-600">{{hh.genre}} genre</div> -->
                                    </div>
                                </form>
...
export default {
    ...
    methods: {
        ...
        async onSubmit(event) {
            const hh = {
                tiktok_link: this.fullprofile.readProfile.tiktok_link,
                city: this.fullprofile.readProfile.city,

                f_name: this.fullprofile.readProfile.f_name,
                l_name: this.fullprofile.readProfile.l_name,
                profile_pic: this.fullprofile.readProfile.profile_pic,
                gender: this.fullprofile.readProfile.gender,
                birth_day: this.fullprofile.readProfile.birth_day,
                country: this.fullprofile.readProfile.country,
                bio: this.fullprofile.readProfile.bio,
                phone: this.fullprofile.readProfile.phone,
                email: this.fullprofile.readProfile.email,
                short_description: this.fullprofile.readProfile.short_description,
                genre: this.fullprofile.readProfile.genre
            }


            event.preventDefault();
            this.updateprofile(hh).then
        ...
        selectCategory(event) {
            ...
            this.fullprofile.readProfile.gender = event.target.value
        },
        selectCategor(event) {
            console.log(event.target.value);
            this.fullprofile.readProfile.genre = event.target.value
        },
